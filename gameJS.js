...
flight.init = function () {
    ...
    flight.effect = new THREE.AnaglyphEffect( flight.renderer );
...
function controlSetUp() {
    flight.controls = new THREE.FlyControls(flight.camGroup, flight.renderer.domElement);
...
function loadAirplane() {
    ...
    loader.load(
        ...
        function (gltf) {
            // gltf.scene.position.y = 4;
            flight.planeStanderd = gltf.scene.getObjectByName("Plane");
            ...
            //   flight.planeStanderd = new THREE.Mesh(flight.planeStanderdInit, flight.planeMaterial);
              ...
              flight.planeStanderd.geometry.getAttribute("position").needsUpdate = true;
            ...
            flight.planeStanderd.rotation.y += 0;//Math.PI;
